## 1) What Nexalis Agent does

- Nexalis Agent **mirrors raw data** from on-premise or remote industrial assets to Nexalis Cloud in **real time**. **Industrial connectors (e.g., OPC UA, Modbus, etc.) extract data from assets**, and gRPC_kafka **loads this raw data securely into Nexalis Cloud**. This is what we describe as mirroring data.    
...
Example of a Nexalis Agent setup using 1 DNP3 connector and 2 Modbus connectors (TCP and RTU) and a cloud data source.
