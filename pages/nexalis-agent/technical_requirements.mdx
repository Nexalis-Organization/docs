...
- For most sites streaming up to ~1,000 events per second, a compact edge device such as the **Compulab IOTG (2 GB of RAM)** is sufficient to run the Nexalis Agent.
- A specification of 2 vCPU and 4 GB of RAM is recommended to stream **more than 1,000 events per second**. This specification supports up to 10,000 events per second and is limited to 30,000 data points.
- A configuration of 4 vCPU and 16 GB of RAM supports up to 35,000 events per second and is limited to 105,000 data points.
...
This buffer guarantees reliable unbuffering once the cloud connection is restored.
...
- **Maximum bandwidth requirement:** approximately **160 kilobits per second**.
- This corresponds to the transmission of around **1,000 samples per second**.
