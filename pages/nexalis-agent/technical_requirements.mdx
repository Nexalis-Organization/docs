...
- A minimum hardware specification of 2 vCPU and 4 GB of RAM is recommended to run the Nexalis Agent. This specification supports up to 10,000 events per second and is limited to 30,000 data points.
