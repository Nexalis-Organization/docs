...
Welcome to the **Nexalis Cloud API Access** documentation. This guide explains how to connect and consume industrial data from **Nexalis Cloud**. It is designed for both technical users (data engineers, developers) and business users (analysts, dashboard creators) who want to integrate Nexalis data into their workflows.
