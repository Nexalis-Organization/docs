...
<img src="/images/nexalis-grafana-plugin/nexalis-grafana-plugin.png" alt="The Grafana panel editor showing a Nexalis query: a day of inverter AC power plotted in kW, with the query built from siteName, logicalNode, deviceID and dataObject filter rows, Auto bucket and Scaling switched on, and a series-name template driving the legend" style={{ maxWidth: "100%" }} />
