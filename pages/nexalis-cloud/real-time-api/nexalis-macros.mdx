...
| `ti` | STRING or LONG | Start timestamp (ISO8601 string or microseconds) |
| `tf` | STRING or LONG | End timestamp (ISO8601 string or microseconds) |
...
These macros can be combined for complex data processing workflows:

```warpscript
// Fetch trapezoidal averages, then apply scaling
$RT
'2025-12-19T10:00:00Z'
'2025-12-19T12:00:00Z'
300000000
'nx.value'
{ 'siteName' 'site_A' 'dataPoint' 'PowerKW' }
@nexalis/fetch_trapezoidal_averages

// Convert kW to MW (assuming multiplier=0.001 is set in attributes)
@nexalis/scale
```
