...
- **[PowerBI Connector](./powerbi-connector)** *(beta)* - Browse and load time series in Power BI, no WarpScript required
...
- **[PowerBI Connector](./powerbi-connector)** - Build dashboards from the Power BI Navigator
