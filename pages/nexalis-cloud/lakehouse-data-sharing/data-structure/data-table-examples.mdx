...
This page provides examples of the actual tables and values available when querying through the **Delta Sharing API**. It complements the [Table Schema](/pages/nexalis-cloud/lakehouse-data-sharing/data-structure/table-schema) page by showing concrete outputs for raw, standardized, averaged, and high-frequency data.
