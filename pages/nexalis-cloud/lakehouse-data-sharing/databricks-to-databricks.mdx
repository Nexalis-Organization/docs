...
Nexalis uses **zero-copy sharing** at the lakehouse layer, so recipients query the same shared data reality without creating duplicate storage copies in their workspace.
